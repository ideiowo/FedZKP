...
LEARNING_RATE = 0.001
R_MAXS = None
wasm_path = "ZKP_CIFAR10/Aggregate_js/Aggregate.wasm"
zkey_path = "ZKP_CIFAR10/Aggregate_0000.zkey"
snarkjs_path = get_snarkjs_path()
project_base_path = "./gradients"
verification_key_path = "ZKP_CIFAR10/verification_key.json"
aggregator = FedAvg()
# 設定聚合方式
...
# 初始化全局模型
initial_model = LeNet5_CIFAR10().to(device)
...
for i in range(NUM_NODES):
    node_model = LeNet5_CIFAR10().to(device)
